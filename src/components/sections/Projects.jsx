        ...
        <div className="max-w-5xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
                    ...
                    <p className="text-gray-400 mb-4"> Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eum consectetur amet officiis necessitatibus quod corrupti deserunt nihil repudiandae quas nulla adipisci a ex tempora, corporis tenetur veniam enim repellendus inventore? </p>
                    <div>
